...
class UpdateMobilRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            'name' => 'required|unique:mobils,name,' . $mobilId . '|max:255|string',
            'warna' => 'nullable|max:255|string',
            'plat_nomor' => 'required|unique:mobils,plat_nomor,' . $mobilId . '|max:255|string',
    ...
    public function messages(): array
    {
        return [
            ...
            'name.unique' => 'Nama mobil sudah ada.',
